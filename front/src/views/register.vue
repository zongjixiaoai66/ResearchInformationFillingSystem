    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">高校教师教研信息填报系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="教研管理姓名" class="input" v-if="tableName=='jioayanguanli'">
                            <el-input v-model="ruleForm.jioayanguanliName" autocomplete="off" placeholder="教研管理姓名"  />
                        </el-form-item>
                        <el-form-item label="教研管理手机号" class="input" v-if="tableName=='jioayanguanli'">
                            <el-input v-model="ruleForm.jioayanguanliPhone" autocomplete="off" placeholder="教研管理手机号"  />
                        </el-form-item>
                        <el-form-item label="教研管理身份证号" class="input" v-if="tableName=='jioayanguanli'">
                            <el-input v-model="ruleForm.jioayanguanliIdNumber" autocomplete="off" placeholder="教研管理身份证号"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="jioayanguanliPhotoFlag">
                            </el-form-item>
                            <el-form-item label="教研管理头像" class="input" v-if="tableName=='jioayanguanli'">
                                    <file-upload
                                        tip="点击上传教研管理头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                        <el-form-item label="教研管理邮箱" class="input" v-if="tableName=='jioayanguanli'">
                            <el-input v-model="ruleForm.jioayanguanliEmail" autocomplete="off" placeholder="教研管理邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='jioayanguanli'">
    ...
    export default {
        data() {
            return {
                ...
                rules: {},
                sexTypesOptions : [],
                jioayanguanliPhotoFlag:false,//用于刷新文件上传
        ...
        methods: {
            ...
            jioayanguanliPhotoUploadChange(fileUrls) {
               this.ruleForm.jioayanguanliPhoto = fileUrls;
                if(this.jioayanguanliPhotoFlag){
                    this.jioayanguanliPhotoFlag=false;
                }else{
                    this.jioayanguanliPhotoFlag=true;
                }
            },
            ...
            login() {
                            ...
                            if((!this.ruleForm.jioayanguanliName)&& 'jioayanguanli'==this.tableName){
                                this.$message.error('教研管理姓名不能为空');
                                return
                            }
                             if('jioayanguanli' == this.tableName && this.ruleForm.jioayanguanliPhone&&(!this.$validate.isMobile(this.ruleForm.jioayanguanliPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.jioayanguanliIdNumber)&& 'jioayanguanli'==this.tableName){
                                this.$message.error('教研管理身份证号不能为空');
                                return
                            }
                            // jioayanguanli 中的 教研管理头像 判空处理
                            // if('jioayanguanli' == this.tableName && (this.ruleForm.jioayanguanliPhoto== null ||this.ruleForm.jioayanguanliPhoto== "")){
                            //     this.$message.error("教研管理头像不能为空");
                            //     return
                            // }
                            if('jioayanguanli' == this.tableName && this.ruleForm.jioayanguanliEmail&&(!this.$validate.isEmail(this.ruleForm.jioayanguanliEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                            // jioayanguanli 中的 创建时间 判空处理
                            // if('jioayanguanli' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/jiaoyanguanlixitong/img/back-img-bg.jpg);
